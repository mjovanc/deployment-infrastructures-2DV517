...
$wpdb->add_database(array(
	'host'     => {{ hostvars['mysqlmaster']['ansible_host'] }},     // If port is other than 3306, use host:port.
	'user'     => {{ mysql_user }},
...
$wpdb->add_database(array(
	'host'     => {{ hostvars['mysqlslave']['ansible_host'] }},     // If port is other than 3306, use host:port.
	'user'     => {{ mysql_user }},
	'password' => {{ mysql_password }},
	'name'     => {{ mysql_db }},
	'write'    => 0,
